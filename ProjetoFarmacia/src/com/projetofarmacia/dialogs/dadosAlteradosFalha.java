 ...
 */
public class dadosAlteradosFalha extends javax.swing.JDialog {

    /**
     * Creates new form dadosCadastradosSucces
     */
    public dadosAlteradosFalha(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("FALHA AO ALTERAR");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dadosAlteradosFalha dialog = new dadosAlteradosFalha(new javax.swing.JFrame(), true);
